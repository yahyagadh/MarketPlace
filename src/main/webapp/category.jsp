...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="userDashboard.jsp">Accueil</a>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <%
                                ...
                                try {
                                    ...
                                    String sql = "SELECT id, nom FROM public.categorie";  // Replace "categories" with your actual table name
                                    PreparedStatement ps = conn.prepareStatement(sql);
                                    ResultSet rs = ps.executeQuery();

                                    // Loop through categories and create a list item for each
                                    while (rs.next()) {
                            ...
                            <%
                                    ...
                                    e.printStackTrace(); // Print full exception stack trace for better debugging
